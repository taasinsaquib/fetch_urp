...
public class LongController : Agent
{
   ...
   private void Start() {
    ...
    public override void OnEpisodeBegin()
    {
      ...
      //set target position
      float theta = Random.Range(-45,45);
      float dist = Random.Range(15,10);
      Target.localPosition = Quaternion.Euler(0, theta, 0) * (center[0].right * -dist) + transform.up * 0.8f;
